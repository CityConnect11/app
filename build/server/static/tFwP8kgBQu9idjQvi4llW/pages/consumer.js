...
/******/ 			var chunk = require("../../../" + ({}[chunkId]||chunkId) + "." + {"8":"b685ec9f2477a6f78b6a"}[chunkId] + ".js");
...
module.exports = __webpack_require__("FrZN");
...
const ConsumerMap = next_dynamic__WEBPACK_IMPORTED_MODULE_1___default()(() => __webpack_require__.e(/* import() */ 8).then(__webpack_require__.bind(null, "eYxW")), {
  ssr: false,
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("eYxW")],
    modules: ['../components/consumer/map']
  }
});

const Consumer = () => {
  return __jsx(_components_frame__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"], null, __jsx(ConsumerMap, null));
};
